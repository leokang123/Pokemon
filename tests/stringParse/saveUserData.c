...
// 이떄 테스트한거랑 헤더파일이랑 좀 다름 에러날거임 

int main() {

    // PokeData prdata = {1, "Pikachu", "Electric", 5, 150, 3, {{1,0,0,0,0},{3,0,0,0,0},{11,0,0,0,0}}};
    // printf("%d", prdata.skillarr[1].idenNum);
    // 샘플 사용자 데이터
    ...
    Userdata *readUserDataArray1 = readUserData("leokang");
    Userdata *readUserDataArray2 = readUserData("ashketchum");
    Userdata *readUserDataArray3 = readUserData("misty");
